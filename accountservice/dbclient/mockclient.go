...
import (
	...
	"github.com/vinhnguyenhq/goblog/accountservice/model"
)
...
// From here, we'll declare three functions that makes our
// MockBoltClient fulfill the interface IBoltClient that we declared in part 3.
